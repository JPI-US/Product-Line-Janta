/**
 * Bakes designer mesh merge + top-panel simplify into 5.6k_10x4_panels-ready.glb.
 * Run via npm run optimize:models (after 5.6k_10x4_panels-web.glb exists).
 */
...
const output = path.join(
  projectRoot,
  "public/models/5.6k_10x4_panels/5.6k_10x4_panels-ready.glb"
);
...
async function main() {
  ...
  console.log("Baking designer ready GLB…");
  ...
  execSync(`npx gltf-transform meshopt "${rawOut}" "${output}"`, {
    stdio: "inherit",
    cwd: projectRoot,
  });
